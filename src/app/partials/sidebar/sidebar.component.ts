...
export class SidebarComponent implements OnInit {
  ...
  // Para el select
  public opciones: any[] = [
    {value: '/registro-usuarios', viewValue: 'Administrador'},
    {value: '/registro-usuarios/', viewValue: 'Maestro'},
    {value: '/registro-usuarios/', viewValue: 'Alumno'},
    {value: '/registro-usuarios/', viewValue: 'Materias'},
  ];
  ...
  onRegisterSelect(value: string | null) {
    if (!value) return;
    this.router.navigate([value]);
    // Si el componente tiene closeSidebar(): ciérralo al navegar (sidebar y mobile)
    if (typeof (this as any).closeSidebar === 'function') {
      (this as any).closeSidebar();
    }
  }
}
